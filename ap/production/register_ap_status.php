          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>AP Registration Status <small></small></h2>
                ...
                $a=0;
                     ...
                     //echo $ids[$x];
						...
						$dsfc="SELECT * FROM `ap` WHERE `s_ap_id`='$_SESSION[ap_id]';";
						$queryc=$con->query($dsfc);
						while($rfgc=mysqli_fetch_assoc($queryc)){
							$a++;
							if($rfgc['status']=="P" || $rfgc['status']=="N")
						    {
							?>
							<tr>
								<td><?php echo $a;?></td>
								...
								<td><?php if($rfgc[status]=="N"){
								echo "Payment Pending";
								    $meterr=0;
								}
								elseif($rfgc[status]=="P")
								{
								    echo "KYC Pending";
								    $meterr=50;
								}
