...
<html lang="en">
  <head>
    ...
    <title>Billing History | EIBO </title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Costumer Billing History</h3>
			  </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Costumer Billing History<small></small></h2>
                ...
                <?php 
						$a=0;
						$dsf="SELECT * FROM `subscription_history` WHERE `ap_id`='$_SESSION[ap_id]' ORDER BY `sh_id` DESC";
						$query=$con->query($dsf);
