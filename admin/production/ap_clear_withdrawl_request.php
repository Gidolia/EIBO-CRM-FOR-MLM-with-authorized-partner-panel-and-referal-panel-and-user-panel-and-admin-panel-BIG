                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <div class="card-box table-responsive">
                    <?php
                    $dsf="SELECT * FROM `ap_withdrawal_request` WHERE `ap_id`='$_GET[ap_id]' AND `status`='P'";
					$query=$con->query($dsf);
					$dsf1="SELECT * FROM `ap` WHERE `ap_id`='$_GET[ap_id]'";
                   ...
                   <table id="datatable" class="table table-striped table-bordered">
                   		...
                   		<tr>
                   			<th>#</th><td><?php echo $rfg[ap_wr_id];?></td></tr>
