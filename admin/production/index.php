    ...
    if($_GET['days']==7)
	  {
		  ...
		  array($date,own_business_on_date($date)),

		  array($date_1,own_business_on_date($date_1)),

		  array($date_2,own_business_on_date($date_2)),

		  array($date_3,own_business_on_date($date_3)),

		  array($date_4,own_business_on_date($date_4)),

		  array($date_5,own_business_on_date($date_5)),

		  array($date_6,own_business_on_date($date_6)),
	  );
	  ?>
        ...
        <div class="right_col" role="main">
          ...
          <div class="tile_count">
            <div class="col-md-2 col-sm-4  tile_stats_count">
              ...
              <div class="count"><?php echo count_ap_count('0');?></div>
              
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Total DRA</span>
              <div class="count"><?php echo count_dra(0);?></div>
              
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Total Costumer</span>
              <div class="count"><?php echo count_costumer();?></div>
             
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> This Month Business (Sales)</span>
              <div class="count green"><?php echo "23548";?></div>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
                ...
                <div class="x_content">
                  <div class="dashboard-widget-content">
                    ...
                    <div class="sidebar-widget">
                        ...
                        <canvas width="150" height="80" id="chart_gauge_01" class="" style="width: 190px; height: 100px;"></canvas>
