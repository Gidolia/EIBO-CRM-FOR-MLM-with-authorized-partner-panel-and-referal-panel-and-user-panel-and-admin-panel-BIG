      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <?php
			  $e_id_ed="SELECT * FROM `employee` WHERE `e_id`='$_SESSION[ibo_id]'";
                    ...
                    <div class="col-md-3 col-sm-3  profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          <img class="img-responsive avatar-view" src="<?php echo $profile_photo_src;?>" height="350" width="100%" alt="Avatar" title="Change the avatar">
                        </div>
                      </div>
	...
	?>
            ...
            <?php }?>
                    ...
                    <div class="col-md-9 col-sm-9 ">
                     ...
                     <?php 
					  $sqlqq="SELECT * FROM `employee` WHERE `e_id`='$_SESSION[ibo_id]'";
					  $red=$con->query($sqlqq);
					  while($fdt=mysqli_fetch_assoc($red))
					  {?>
						  <tr><th>User Name</th><td><?php echo $fdt[u_name];?></td></tr>
						  ...
						  <tr><th>Addreass</th><td><?php echo $fdt[addreass];?></td></tr>
						  <tr><th>City (State)</th><td><?php echo $fdt[city];?>(<?php echo $fdt[state];?>)</td></tr>
						  <tr><th>Joining Date</th><td><?php echo $fdt[joining_date];?></td></tr>
						  ...
						  <tr><th>Email ID</th><td><?php echo $fdt[email_id];?></td></tr>
