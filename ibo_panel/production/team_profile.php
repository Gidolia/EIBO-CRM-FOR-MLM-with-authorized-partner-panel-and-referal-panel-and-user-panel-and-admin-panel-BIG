                  ...
                  <div class="x_content">
                    ...
                    <div class="x_content">
                     ...
                     <hr>
                      ...
                      <a href="team_profile.php?e_id=<?php echo $_GET[e_id];?>&step=1" class="btn btn-info form-control">Daily Working Report</a>
                      <a href="team_profile.php?e_id=<?php echo $_GET[e_id];?>&step=2" class="btn btn-info form-control">Their Contact List</a>
