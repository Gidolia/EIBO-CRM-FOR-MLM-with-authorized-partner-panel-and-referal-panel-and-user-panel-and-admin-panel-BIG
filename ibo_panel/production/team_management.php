...
<html lang="en">
  <head>
    ...
    <title>Team Management | Success youth Network Team </title>
                   ...
                   <table id="datatable" class="table table-striped table-bordered">
                   	...
                   	<tbody>
						...
						if(isset($_GET[e_id]))
						{
							...
							$e_id=$_SESSION[ibo_id];
						}
						
					  $hut="SELECT * FROM `employee` WHERE `s_id`='$e_id'";
					  ...
					  while($rot=mysqli_fetch_assoc($query))
					  {
						  ...
						  $sqlddfbr="SELECT * FROM `master_data_record_contact_list` WHERE `e_id`='$rot[e_id]' AND `date`='$date'";
						  $qude=$con->query($sqlddfbr);
						  $activity_counter=mysqli_num_rows($qude);
					  ...
					  <tr>
					    <td><?php echo $a;?></td>
					  	...
					  	<td><?php echo find_own_activity($rot[e_id],$date,1);?></td>
					  	 <td><?php echo find_downline_activity($rot[e_id],$date,1);?></td>
