          ...
          <div class="">
            ...
            <div class="row tile_count">
                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <a href="withdrawl_wallet.php"><div class="tile-stats">
                      ...
                      <div class="count"><i class="fa fa-inr"></i> <?php echo this_month_business($_SESSION[dra_id]);?></div>
                ...
                <div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <a href="withdrawl_wallet.php"><div class="tile-stats">
                      <div class="icon"><i class="fa fa-money"></i></div>
                      <div class="count"><i class="fa fa-inr"></i> <?php echo this_month_commission($_SESSION[dra_id]);?></div>
                ...
                $tb=0;
                $tc=0;
                $dsf="SELECT * FROM `dra_commission` WHERE `dra_id`='$_SESSION[dra_id]' ORDER BY `drac_id` DESC";
						$query=$con->query($dsf);
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                ...
                <?php 
						$a=0;
						$dsfe="SELECT * FROM `dra_commission` WHERE `dra_id`='$_SESSION[dra_id]' ORDER BY `drac_id` DESC";
