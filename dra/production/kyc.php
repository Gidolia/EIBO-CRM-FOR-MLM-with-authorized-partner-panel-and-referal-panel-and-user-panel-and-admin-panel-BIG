...
$zx="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='C' AND `kyc_for`='photo'";
                  $xz=$con->query($zx);
	if($xz->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
$x="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='N' AND `kyc_for`='photo'";
                  $z=$con->query($x);
	if($z->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
<?php
                  ...
                  $s="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='P' AND `kyc_for`='photo'";
                  $k=$con->query($s);
	if($k->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
$zx="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='C' AND `kyc_for`='adhar'";
                  $xz=$con->query($zx);
	if($xz->num_rows !=0)
	{ ?>
                  <br>&nbsp;<br>
...
$x="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='N' AND `kyc_for`='adhar'";
                  $z=$con->query($x);
	if($z->num_rows !=0)
	{ ?>
                  <br>&nbsp;<br>
...
<?php
                  ...
                  $s="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='P' AND `kyc_for`='adhar'";
                  $k=$con->query($s);
	if($k->num_rows !=0)
	{ ?>
                  <br>&nbsp;<br>
...
$zx="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='C' AND `kyc_for`='bank'";
                  $xz=$con->query($zx);
	if($xz->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
$x="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='N' AND `kyc_for`='bank'";
                  $z=$con->query($x);
	if($z->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
<?php
                  ...
                  $s="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='P' AND `kyc_for`='bank'";
                  $k=$con->query($s);
	if($k->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
$zx="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='C' AND `kyc_for`='pancard'";
                  $xz=$con->query($zx);
	if($xz->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
$x="SELECT * FROM `dra_kyc` WHERE `ap_id`='$_SESSION[dra_id]' AND `status`='N' AND `kyc_for`='pancard'";
                  $z=$con->query($x);
	if($z->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
<?php
                  ...
                  $s="SELECT * FROM `dra_kyc` WHERE `dra_id`='$_SESSION[dra_id]' AND `status`='P' AND `kyc_for`='pancard'";
                  $k=$con->query($s);
	if($k->num_rows!=0)
	{ ?>
                  <br>&nbsp;<br>
...
for($x=0; $x<100; $x++)
{
    ...
    $sqsqqs="SELECT * FROM `dra_kyc` WHERE `unique_id`='$pas'";
    ...
    if(mysqli_num_rows($qur)==0)
    {
		...
		if(move_uploaded_file($_FILES["adharb"]["tmp_name"], "adhar_card_img/".$pas."b.jpg"))
		{
            ...
            $que="INSERT INTO `dra_kyc` (`dra_kyc_id`, `dra_id`, `date`, `time`, `kyc_for`, `adhar_front_img`, `adhar_back_img`, `adhar_no`, `pancard_img`, `pan_no`, `bank_acc_no`, `bank_ifsc`, `bank_name`, `bank_img`, `status`, `unique_id`, `photo`) VALUES (NULL, '$_SESSION[dra_id]', '$date', '$time', 'adhar', '$pas', '$pas', '$_POST[adhar_no]', '', '', '', '', '', '', 'P', '$pas', '');";
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(move_uploaded_file($_FILES["bank_pass"]["tmp_name"], "bank_img/".$pas.".jpg"))
		{
            ...
            $que1="INSERT INTO `dra_kyc` (`dra_kyc_id`, `dra_id`, `date`, `time`, `kyc_for`, `adhar_front_img`, `adhar_back_img`, `adhar_no`, `pancard_img`, `pan_no`, `bank_acc_no`, `bank_ifsc`, `bank_name`, `bank_img`, `status`, `unique_id`, `photo`) VALUES (NULL, '$_SESSION[dra_id]', '$date', '$time', 'bank', '', '', '', '', '', '$_POST[acc_no]', '$_POST[ifsc]', '$_POST[bank_name]', '$pas', 'P', '$pas', '');";
        ...
        if(move_uploaded_file($_FILES["pan"]["tmp_name"], "pan_card_img/".$pas.".jpg"))
		{
            ...
            $que2="INSERT INTO `dra_kyc` (`dra_kyc_id`, `dra_id`, `date`, `time`, `kyc_for`, `adhar_front_img`, `adhar_back_img`, `adhar_no`, `pancard_img`, `pan_no`, `bank_acc_no`, `bank_ifsc`, `bank_name`, `bank_img`, `status`, `unique_id`, `photo`) VALUES (NULL, '$_SESSION[dra_id]', '$date', '$time', 'pancard', '', '', '', '$pas', '$_POST[pan_no]', '', '', '', '', 'P', '$pas', '');";
            if($con->query($que2)==TRUE)
            {
        ...
        if(move_uploaded_file($_FILES["photo"]["tmp_name"], "photo/".$pas.".jpg"))
		{
            ...
            $que3="INSERT INTO `dra_kyc` (`dra_kyc_id`, `dra_id`, `date`, `time`, `kyc_for`, `adhar_no`, `pan_no`, `bank_acc_no`, `bank_ifsc`, `bank_name`, `status`, `unique_id`) VALUES (NULL, '$_SESSION[dra_id]', '$date', '$time', 'photo', '', '', '', '', '', 'P', '$pas');";
            $que1="INSERT INTO `dra_kyc` (`dra_kyc_id`, `dra_id`, `date`, `time`, `kyc_for`, `adhar_front_img`, `adhar_back_img`, `adhar_no`, `pancard_img`, `pan_no`, `bank_acc_no`, `bank_ifsc`, `bank_name`, `bank_img`, `status`, `unique_id`, `photo`) VALUES (NULL, '$_SESSION[dra_id]', '$date', '$time', 'photo', '', '', '', '', '', '', '', '', '', 'P', '$pas', '$pas');";
            if($con->query($que3)==TRUE)
            {
