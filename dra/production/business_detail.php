...
<html lang="en">
  <head>
    ...
    <title>Business Detail || EIBO </title>
          ...
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <?php 
						$a=0;
						$tot_price=0;
						$dsf="SELECT * FROM `subscription_history` WHERE `dra_id`='$_SESSION[dra_id]' ORDER BY `sh_id` DESC";
						$query=$con->query($dsf);
						while($rfg=mysqli_fetch_assoc($query))
						{
							$sd="SELECT * FROM `employee` WHERE `e_id`='$rfg[e_id]'";
							$dcv=$con->query($sd);
							$svb=mysqli_fetch_assoc($dcv);
							$a++;
							$tot_price=$tot_price+$rfg[billing_amount];
							?>
							<tr>
							<td><?php echo $a;?></td>
                   	...
                   	<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><th>Total</th><th><?php echo $tot_price;?></th></tr>
                   </table>
