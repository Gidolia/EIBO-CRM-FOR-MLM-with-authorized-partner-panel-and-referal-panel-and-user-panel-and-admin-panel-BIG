...
<html lang="en">
  <head>
    ...
    <title>Hold Wallet Ledger| EIBO </title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered" id="datatable">
            ...
            <?php
            $a=0;
            $g="SELECT * FROM `dra_hold_wallet_ledger` WHERE `dra_id`='$_SESSION[dra_id]' ORDER BY `dra_hold_wallet_ledger`.`drahwl_id` DESC";
            $dc=$con->query($g);
